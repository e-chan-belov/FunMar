...
public:
    PartialAbstraction() {}
    PartialAbstraction(const PartialAbstraction& partial) : inputRealization(partial.inputRealization), abstraction(partial.abstraction), callFunctionIterator(partial.callFunctionIterator) {}
    ...
    bool isActive() { return callFunctionIterator.isAtList() && abstraction.size() != 0; }
